...
export const SFX: Record<string, SfxAsset> = {
  ...
  'sfx-pounce': { tone: { freq: 340, sweepTo: 820, durationMs: 150, type: 'square', volume: 0.22 } },
  'sfx-zoomies': { tone: { freq: 220, sweepTo: 1150, durationMs: 260, type: 'sawtooth', volume: 0.18 } },
  'sfx-meow': { tone: { freq: 480, sweepTo: 950, durationMs: 200, type: 'triangle', volume: 0.26 } },
  'sfx-whirl': { tone: { freq: 260, sweepTo: 640, durationMs: 240, type: 'sine', volume: 0.2 } },
